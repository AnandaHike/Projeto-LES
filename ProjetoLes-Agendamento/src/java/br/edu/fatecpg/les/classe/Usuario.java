...
public class Usuario {
    ...
    public static void CadastrarUsuario(String login, String nome, String role, String cpf, String telefone, String password)throws Exception{
        Connection con = DbListener.getConnection();
    ...
    public Usuario(String login, String nome, String role, String cpf, String telefone) {
        this.login = login;
        this.nome = nome;
        this.role = role;
        this.cpf = cpf;
